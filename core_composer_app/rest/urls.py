...
urlpatterns = [
    re_path(r'^type-version-manager/global/$',
    ...
    re_path(r'^type-version-manager/(?P<pk>\w+)/disable/$',
    ...
    re_path(r'^type-version-manager/(?P<pk>\w+)/restore/$',
    ...
    re_path(r'^type/version/(?P<pk>\w+)/restore/$',
            template_version_manager_views.RestoreTemplateVersion.as_view(),
            name='core_composer_app_rest_type_version_restore'),

    re_path(r'^type/(?P<pk>\w+)/download/$', template_views.TemplateDownload.as_view(),
            name='core_composer_app_rest_type_download'),

    re_path(r'^type/(?P<pk>\w+)/$', template_views.TemplateDetail.as_view(),
